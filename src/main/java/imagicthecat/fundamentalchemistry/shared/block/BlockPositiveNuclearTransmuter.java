...
public class BlockPositiveNuclearTransmuter extends Block implements ITileEntityProvider{

	public BlockPositiveNuclearTransmuter() {
	  super(Material.ROCK);
	  this.setHardness(1.5f);
	  this.setUnlocalizedName("positive_nuclear_transmuter");
	  this.setRegistryName("positive_nuclear_transmuter");
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TilePositiveNuclearTransmuter();
	}
